(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-basket-one")) new core(".swiper-basket-one", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-basket-one__swiper-button-prev",
                nextEl: ".swiper-basket-one__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-basket-two")) new core(".swiper-basket-two", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-basket-two__swiper-button-prev",
                nextEl: ".swiper-basket-two__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    if (titlePage) if ("главная" == titlePage) {
    ...
    function buttonClick(e) {
        if (e.target.closest(".popup-show")) {
            ...
            if (delShow) delShow.classList.remove("_header-show");
        }
    }
    const script_form = document.querySelector(".form-control");
    const inputs = script_form.querySelectorAll("input");
    const KEYBOARDS = {
        backspace: 8,
        arrowLeft: 37,
        arrowRight: 39
    ...
    script_form.addEventListener("input", handleInput);
